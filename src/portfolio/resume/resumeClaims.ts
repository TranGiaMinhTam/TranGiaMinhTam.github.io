...
export const reviewedResumeClaims = Object.freeze([
  ...
  claim('resume-molecular-docking', 'computational-research', 'Molecular Docking Model for Type II Diabetes Targets', 'Built a computational molecular-docking workflow across SUR1, DPP4, GLR-1R, PPAR-γ and SGLT2 using AutoDock Vina, plus an interactive platform for protein–ligand visualisation.', 2, 14, { period: 'August 2025 – June 2026', evidenceIds: ['evidence-protein-docking-publication', 'evidence-docking-research-completion', 'evidence-docking-poster-presentation', 'evidence-docking-oral-presentation', 'evidence-docking-conference-poster', 'evidence-docking-workstation'], existingRecordId: 'project-molecular-docking-model' }),
