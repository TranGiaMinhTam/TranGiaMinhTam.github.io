...
import dockingResearchCompletion from '../../assets/minh-tam/source/Science research /2026 Protein Docking/IMG_4206.JPG'
import dockingPosterPresentation from '../../assets/minh-tam/source/Science research /2026 Protein Docking/IMG_4213.JPG'
import dockingOralPresentation from '../../assets/minh-tam/source/Science research /2026 Protein Docking/IMG_4207.JPG'
import dockingConferencePoster from '../../assets/minh-tam/source/Science research /2026 Protein Docking/IMG_4208.JPG'
import dockingWorkstation from '../../assets/minh-tam/source/Science research /2026 Protein Docking/7381606024551.jpg'
...
export const evidenceManifest = Object.freeze([
  ...
  document('evidence-borsworth-scholarship', '80% scholarship offer', 'Two-page scholarship offer preview.', 'scholarship', 'generated/minh-tam/document-preview/borsworth-scholarship-first-2-pages.pdf', borsworthScholarship),
  ...
  document('evidence-protein-docking-publication', '2026 molecular docking conference proceedings', 'Conference publication for the Type II diabetes docking study.', 'publication', 'projects/protein-docking/conference-proceedings.pdf', proteinDockingPublication),
  ...
  document('evidence-worthgate-scholarship', '90% scholarship offer', 'Two-page scholarship offer preview.', 'scholarship', 'generated/minh-tam/document-preview/worthgate-scholarship-first-2-pages.pdf', worthgateScholarship),
  image('evidence-docking-research-completion', 'Protein docking research completion', 'The research team at the 2026 project completion presentation.', 'projects/protein-docking/research-completion.jpg', dockingResearchCompletion),
  image('evidence-docking-poster-presentation', 'Protein docking poster presentation', 'The research team presenting the molecular docking poster in March 2026.', 'projects/protein-docking/poster-presentation.jpg', dockingPosterPresentation),
  image('evidence-docking-oral-presentation', 'Protein docking oral presentation', 'Presentation of the Type II diabetes molecular docking project.', 'projects/protein-docking/oral-presentation.jpg', dockingOralPresentation),
  image('evidence-docking-conference-poster', 'Protein docking conference poster', 'The research team with the molecular docking poster at the 2026 pharmacy conference.', 'projects/protein-docking/conference-poster.jpg', dockingConferencePoster),
  image('evidence-docking-workstation', 'Protein docking workstation', 'Computational modelling work shown on the laboratory workstation.', 'projects/protein-docking/workstation.jpg', dockingWorkstation),
